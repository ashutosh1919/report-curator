...
function getViewers(octokit, owner, repository) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, apiOps.getGitResponseV3(octokit, "GET /repos/" + owner + "/" + repository + "/traffic/views")];
...
function getCloners(octokit, owner, repository) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, apiOps.getGitResponseV3(octokit, "GET /repos/" + owner + "/" + repository + "/traffic/clones")];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
